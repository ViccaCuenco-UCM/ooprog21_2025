public class StringBuilderDemo {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("(Length set to 20 for StringBuilder 1) The name is now: " + nameString);
        System.out.println("(Length set to 20 for StringBuilder 2) The address is now: " + addressString);
